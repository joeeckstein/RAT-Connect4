...
architecture my_sseg of sseg_dec is
	...
	signal	mmsd		 : std_logic_vector (3 downto 0);
...
begin
	...
	process (cnt_dig, lsd, msd, mmsd, sign, valid)
		variable mmsd_v : std_logic_vector(3 downto 0);
		variable msd_v  : std_logic_vector(3 downto 0);	 
	begin
		mmsd_v := mmsd; 
		msd_v  := msd; 
...
begin
	process(bin_cnt_in)
		...
		variable lsd     : INTEGER range 0 to 9 := 0; 
		variable msd     : INTEGER range 0 to 9 := 0; 
		variable mmsd    : INTEGER range 0 to 9 := 0; 
	begin
...
-----------------------------------------------------------------------
entity sseg_clk_div is
	Port (	clk : in std_logic;
		   sclk : out std_logic);
end sseg_clk_div;

architecture the_sseg_clk_div of sseg_clk_div is
